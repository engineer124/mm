...
#define WEEKEVENTREG_TATL_HINT_UNK_GOHT PACK_WEEKEVENTREG_FLAG(31, 0x01)
#define WEEKEVENTREG_TATL_HINT_UNK_GYORG PACK_WEEKEVENTREG_FLAG(31, 0x02)

// Unconfirmed: "Tatl's Second Cycle Text?"
#define WEEKEVENTREG_TATL_HINT_DEKU_MASK PACK_WEEKEVENTREG_FLAG(31, 0x04)
...
#define WEEKEVENTREG_TATL_HINT_UNK_TWINMOLD PACK_WEEKEVENTREG_FLAG(80, 0x04)
