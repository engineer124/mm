...
typedef enum PlayerCsAction {
    ...
    /* 0x10 */ PLAYER_CSACTION_PLAY_OCARINA_HUMAN,
    ...
    /* 0x44 */ PLAYER_CSACTION_PLAY_OCARINA,
    /* 0x45 */ PLAYER_CSACTION_PUT_AWAY_OCARINA,
    ...
    /* 0x67 */ PLAYER_CSACTION_SPAWN_ELEGY_SHELL,
...
bool Player_IsUsingFpsItem(Player* player);
bool Player_IsAimingFpsItem(Player* player);
bool Player_IsMakingNoticableSfx(struct PlayState* play);
...
void Player_SetBlockExchangeItemAction(struct PlayState* play, s32 itemAction);
void Player_UpdateChangingPlayerForm(Actor* thisx, struct PlayState* play2);
...
PlayerItemAction Player_RequestExchangeItemAction(struct PlayState* play);
...
void Player_AdjustLegs(struct PlayState* play, Player* player, s32 limbIndex, Vec3f* pos, Vec3s* rot);
