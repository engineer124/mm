...
typedef struct Player {
    ...
    /* 0xAE7 */ union { // context dependent variable that has different meanings depending on what action is currently running
                    s8 actionVar1;
    ...
    /* 0xAE8 */ union { // context dependent variable that has different meanings depending on what action is currently running
                    s16 actionVar2;
