...
void Actor_DamagePlayer(PlayState* play, Actor* actor, f32 damageSpeedXZ, s16 damageYaw, f32 damageSpeedY, u32 specialDamageEffect, u32 damageAmount);
void Actor_KnockbackPlayer(PlayState* play, Actor* actor, f32 damageSpeedXZ, s16 damageYaw, f32 damageSpeedY, u32 damageAmount);
void Actor_KnockbackPlayerNoDamage(PlayState* play, Actor* actor, f32 damageSpeedXZ, s16 damageYaw, f32 damageSpeedY);
void Actor_FlinchPlayer(PlayState* play, Actor* actor, f32 damageSpeedXZ, s16 damageYaw, f32 damageSpeedY, u32 damageAmount);
