...
void SoundSource_Add(GlobalContext* globalCtx, Vec3f* pos, u32 duration, u16 sfxId, u32 arg4);
void SoundSource_PlaySoundByPosition(GlobalContext* globalCtx, Vec3f* position, u32 duration, u16 sfxId);
void SoundSource_PlaySoundByPositionWithReplays(GlobalContext* globalCtx, Vec3f* position, u32 duration, u16 sfxId);
...
void AudioHeap_ReleaseNotesForFont(s32 bankId);
...
void Audio_AudioAllocPoolInit(AudioAllocPool* pool, void* memAddr, u32 size);
...
void AudioHeap_PopCache(s32 poolIdx);
...
void* AudioHeap_AllocCached(s32 poolIdx, s32 size, s32 arg2, s32 id);
void* AudioHeap_SearchCaches(s32 poolIdx, s32 arg1, s32 bankId);
void* AudioHeap_SearchRegularCaches(s32 poolIdx, s32 arg1, s32 bankId);
void func_8018C4E4(f32 arg0, f32 arg1, u16* arg2);
void AudioHeap_ClearFilter(s16* filter);
void AudioHeap_LoadLowPassFilter(s16* filter, s32 arg1);
void AudioHeap_LoadHighPassFilter(s16* filter, s32 arg1);
void AudioHeap_LoadFilter(s16* filter, s32 arg1, s32 arg2);
void AudioHeap_UpdateReverbs(void);
void AudioHeap_ClearAiBuffers(void);
s32 AudioHeap_ResetStep(void);
void AudioHeap_Init(void);
void* AudioHeap_SearchPermanentCache(s32 poolIdx, s32 id);
void* AudioHeap_AllocPermanent(s32 poolIdx, s32 id, u32 size);
void* AudioHeap_AllocSampleCache(u32 size, s32 fontId, void* arg2, s8 arg3, s32 arg4);
void AudioHeap_InitSampleCaches(u32 arg0, u32 arg1);
SampleCacheEntry* AudioHeap_AllocTemporarySampleCacheEntry(u32 size);
void AudioHeap_UnapplySampleCacheForFont(SampleCacheEntry* entry, s32 bankId);
...
void AudioHeap_DiscardSampleCacheForFont(SampleCacheEntry* entry, s32 arg1, s32 arg2, s32 bankId);
void AudioHeap_DiscardSampleCaches(void);
// void AudioHeap_ChangeStorage(void);
void AudioHeap_DiscardSampleBank(s32 id);
void AudioHeap_ApplySampleBankCache(s32 id);
void AudioHeap_ApplySampleBankCacheInternal(s32 arg0, s32 id);
void AudioHeap_DiscardSampleBanks(void);
// void AudioHeap_SetReverbData(void);
// void AudioHeap_InitReverb(s32 id, ReverbSettings* settings, s32 arg2);
...
s32 AudioLoad_IsSampleLoadComplete(s32 tabId);
void AudioLoad_SetFontLoadStatus(s32 bankId, s32 status);
void AudioLoad_SetSeqLoadStatus(s32 seqId, s32 status);
void AudioLoad_SetSampleFontLoadStatusAndApplyCaches(s32 arg0, s32 arg1);
void AudioLoad_SetSampleFontLoadStatus(s32 tabId, s32 status);
void AudioLoad_InitTable(AudioTable* table, u32 romAddr, u16 arg2);
// SoundFontData* AudioLoad_SyncLoadSeqFonts(s32 arg0, u32* arg1);
void AudioLoad_SyncLoadSeqParts(s32 channelIdx, s32 arg1, s32 arg2, OSMesgQueue* arg3);
s32 AudioLoad_SyncLoadSample(SoundFontSample* sample, s32 arg1);
s32 AudioLoad_SyncLoadInstrument(s32 arg0, s32 arg1, s32 arg2);
void AudioLoad_AsyncLoad(s32 tableType, s32 arg1, s32 arg2, s32 arg3, OSMesgQueue* queue);
void AudioLoad_AsyncLoadSeq(s32 arg0, s32 arg1, s32 arg2, OSMesgQueue* queue);
void AudioLoad_AsyncLoadSampleBank(s32 arg0, s32 arg1, s32 arg2, OSMesgQueue* queue);
void AudioLoad_AsyncLoadFont(s32 arg0, s32 arg1, s32 arg2, OSMesgQueue* queue);
u8* AudioLoad_GetFontsForSequence(s32 arg0, u32* arg1);
void AudioLoad_DiscardSeqFonts(s32 arg0);
void AudioLoad_DiscardFont(s32 arg0);
...
u32 AudioLoad_GetSampleBank(u32 arg0, u32* arg1);
u32 AudioLoad_TrySyncLoadSampleBank(u32 arg0, u32* arg1, s32 arg2);
// SoundFontData* AudioLoad_SyncLoadFont(u32 bankId);
void* AudioLoad_SyncLoad(s32 tableType, u32 tableIdx, s32* didAllocate);
u32 AudioLoad_GetRealTableIndex(s32 tableType, u32 tableIdx);
void* AudioLoad_SearchCaches(s32 tableType, s32 id);
AudioTable* AudioLoad_GetLoadTable(s32 tableType);
// void AudioLoad_RelocateFont(s32 bankId, SoundFontData* mem, RelocInfo* relocInfo);
void AudioLoad_SyncDma(u32 devAddr, u8* addr, u32 size, s32 handleType);
void AudioLoad_SyncDmaUnkMedium(u32 devAddr, u8* addr, u32 size, s32 handleType);
s32 AudioLoad_Dma(OSIoMesg* mesg, u32 priority, s32 direction, u32 devAddr, void* ramAddr, u32 size, OSMesgQueue* reqQueue, s32 handleType, const char* dmaFuncType);
void AudioLoad_SyncLoadSimple(u32 tableType, u32 bankId);
void* AudioLoad_AsyncLoadInner(s32 tableType, s32 arg1, s32 arg2, s32 arg3, OSMesgQueue* retQueue);
void AudioLoad_ProcessLoads(s32 resetStatus);
void AudioLoad_SetDmaHandler(DmaHandler callback);
void AudioLoad_SetUnusedHandler(void* callback);
void AudioLoad_InitSoundFontMeta(s32 arg0);
void AudioLoad_Init(void* heap, u32 heapSize);
void AudioLoad_InitSlowLoads(void);
s32 AudioLoad_SlowLoadSample(s32 arg0, s32 arg1, s8* isDone);
SoundFontSample* AudioLoad_GetFontSample(s32 bankId, s32 sfxId);
void AudioLoad_FinishSlowLoad(AudioSlowLoad* syncLoad);
void AudioLoad_ProcessSlowLoads(s32 resetStatus);
void AudioLoad_DmaSlowCopy(AudioSlowLoad* arg0, s32 size);
void AudioLoad_DmaSlowCopyUnkMedium(s32 devAddr, s32 ramAddr, u8* size, s32 arg3);
s32 AudioLoad_SlowLoadSeq(s32 playerIdx, u8* ramAddr, s8* isDone);
void AudioLoad_InitAsyncLoads(void);
AudioAsyncLoad* AudioLoad_StartAsyncLoadUnkMedium(s32 arg0, u32 devAddr, void* ramAddr, s32 size, s32 arg4, s32 nChunks, OSMesgQueue* retQueue, s32 retMsg);
AudioAsyncLoad* AudioLoad_StartAsyncLoad(u32 devAddr, void* ramAddr, u32 size, s32 arg3, s32 nChunks, OSMesgQueue* retQueue, s32 retMsg);
void AudioLoad_ProcessAsyncLoads(s32 resetStatus);
void AudioLoad_ProcessAsyncLoadUnkMedium(AudioAsyncLoad* arg0, s32 arg1);
...
u8* AudioCmd_GetFontsForSequence(s32 seqId, u32* arg1);
...
void Audio_InitExternalPool(void* memAddr, u32 size);
...
s32 AudioPlayback_SetFontInstrument(s32 instrument, s32 bankId, s32 instId, void* arg3);
...
s32 AudioSeq_SeqLayerProcessScriptStep5(SequenceLayer* layer, s32 arg1);
s32 AudioSeq_SeqLayerProcessScriptStep2(SequenceLayer* layer);
s32 AudioSeq_SeqLayerProcessScriptStep4(SequenceLayer* layer, s32 arg1);
s32 AudioSeq_SeqLayerProcessScriptStep3(SequenceLayer* layer, s32 arg1);
...
// void AudioOcarina_SetDisplayedSong(void);
...
void Audio_PlayMainBgm(s8 arg0);
// void Audio_ComputeSfxVolume(void);
// void Audio_ComputeSfxReverb(void);
// void Audio_ComputeSfxPanSigned(void);
// void Audio_ComputeSfxFreqScale(void);
// void Audio_ComputeSurroundSoundFilter(void);
s8 Audio_ComputeSurroundSoundMixVolume(f32 arg0, u16 sfxParams);
...
void Audio_PlaySfxForMessageCancel(void); // Plays "No" sound
// void Audio_AddSfxSetting(void);
...
// void Audio_PlaySfxAtPosForMetalEffectsWithSyncedFreqAndVolume(void);
void Audio_PlaySfxAtPosWithSyncedFreqAndVolume(Vec3f* pos, u16 sfxId, f32 arg2);
...
// void Audio_PlaySfxForSwordCharge(void);
// void Audio_PlaySfxAtPosWithFreqAndVolume(void);
void Audio_PlaySfxAtPosWithFreq(Vec3f* param_1, u16 param_2, f32 param_3);
// void Audio_PlaySfxAtPosWithFreqAndSoundScriptIO(void);
// void Audio_PlaySfxForWaterWheel(void);
// void Audio_PlaySfxAtPosWithTimer(void);
void Audio_SetSfxTimerLerpInterval(s8 arg0, s8 arg1);
void Audio_PlaySfxAtPosWithReverb(Vec3f* pos, u16 sfxId, s8 arg2);
void Audio_PlaySfxAtPosWithVolume(Vec3f* pos, u16 sfxId, f32 arg2);
// void Audio_SetSfxVolumeTransition(void);
// void Audio_UpdateSfxVolumeTransition(void);
// void Audio_PlaySfxForFishingReel(void);
...
// void Audio_SetMainBgmVolume(void);
// void Audio_SetGanonsTowerBgmVolumeLevels(void);
// void Audio_SetGanonsTowerBgmVolume(void);
void Audio_SetMainBgmVolumeTemporarily(u8 arg0);
...
void Audio_SetSfxChannelIO(Vec3f* pos, u16 sfxId, u8 arg2);
void Audio_PlaySfxAtPosWithChannelIO(Vec3f* pos, u16 sfxId, u8 arg2);
// void Audio_PlaySfxAtPosWithAllChannelsIO(void);
// void func_801A09D4(void);
// void Audio_SplitBgmChannels(void);
// void Audio_SetSequenceProperties(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE4 param_5, UNK_TYPE4 param_6, UNK_TYPE4 param_7);
// void Audio_UpdateSequenceAtFixedPos(void);
// void Audio_SetSequenceAtFixedPosParams(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE4 param_5, UNK_TYPE4 param_6, UNK_TYPE4 param_7);
// void Audio_StartFanfareAtFixedPos(void);
void Audio_PlayMainBgmAtFixedPos(Vec3f*, s8);
void Audio_PlayFanfareAtFixedPos(Vec3f* arg0, s8 arg1);
// void Audio_UpdateFanfareAtFixedPos(void);
// void Audio_StopSequenceAndBgmVolumeOn(void);
// void Audio_StartSubBgmAtFixedPos(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE4 param_5, UNK_TYPE4 param_6);
void Audio_PlaySubBgmAtFixedPos(Vec3f* vec, u8 seqId, f32 arg2);
void Audio_PlaySubBgmAtFixedPosWithFilter(Vec3f* vec, u8 seqId, f32 arg2);
...
// void Audio_SetupBgmForNewDayScene(void);
// void Audio_PlayBgmForDayScene(void);
// void Audio_StartBgmForScene(void);
// void Audio_UpdateBgmPlayerIOPort7(void);
// void Audio_PlayBgmForSongOfStorms(void);
// void Audio_ScaleTempoAndFreqForMainBgm(void);
void Audio_ScaleTempoAndFreqForSequence(u8 arg0, f32 arg1, u8 arg2);
void Audio_PlaySubBgm(u16 seqId);
void Audio_StopSubBgm(void);
// void Audio_IncreaseTempoForMinigame(void);
// void Audio_PlaySequenceInCutscene(void);
// void Audio_StopSequenceInCutscene(void);
s32 Audio_IsSequencePlaying(u8 seqId);
void Audio_PlayBgmForMiniBoss(u16 arg0);
void Audio_RestorePreviousBgm(void);
// void Audio_SetupNatureAmbienceSequence(void);
// void Audio_PlayFanfareWithPlayerIOPort7(void);
// void Audio_MuteBgmPlayersForFanfare(void);
void Audio_PlayFanfare(u16 seqId);
// void Audio_UpdateFanfare(void);
void Audio_PlayFanfareWithPlayerIOCustomPort(u16 seqId, s8 arg2, u8 arg3);
// void Audio_PlaySeqWithPlayerIO(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE1 param_5);
void Audio_SetSequenceMode(u8 arg0);
// void Audio_UpdateEnemyBgmVolume(void);
// void func_801A3950(void);
u8 func_801A39F8(void);
// void Audio_SetPauseState(void);
// void Audio_UpdatePauseState(void);
// void Audio_PlaySfxForWindow(void);
void Audio_MuteSeqPlayerBgmSub(u8 arg0);
...
void Audio_PlaySfxGeneralIfNotInCutscene(u16 sfxId, Vec3f* pos, u8 token, f32* freqScale, f32* vol, s8* reverbAdd);
void Audio_PlaySfxIfNotInCutscene(u16 sfxId);
// void Audio_MuteSfxAndNatureSeqExceptOcaAndSys(UNK_TYPE1 param_1);
void Audio_SetSpec(u8 bgmId);
// void Audio_MuteAllSeqExceptSysAndOca(void);
// void Audio_MuteSfxAndNatureSeqExceptSysAndOca(void);
// void Audio_StopFanfare(void);
...
// void Audio_SetSfxReverbIndexExceptOcarinaBank(void);
...
// void Audio_PlaySfxAtPosWithVolumeTransition(void);
// void Audio_SetNatureAmbienceChannelIO(void);
// void Audio_StartNatureAmbienceSequence(void);
// void Audio_PlayNatureAmbienceSequence(void);
// void Audio_SetNatureAmbienceBend(void);
...
void Audio_RemoveSfxBankEntry(u8 bankId, u8 bankIndex);
void Audio_ChooseActiveSfxs(u8 arg0);
...
void Audio_StopSfxByTokenAndId(u8 arg0, u16 sfxId);
...
// void Audio_StartSequence(void);
// void Audio_StopSequence(void);
// void Audio_ProcessSeqCmd(void);
void Audio_QueueSeqCmd(u32 cmd);
// void Audio_ProcessSeqCmds(void);
u16 Audio_GetActiveSequence(u8 playerIdx);
// void Audio_IsSeqCmdNotQueued(void);
