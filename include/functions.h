...
// void Audio_ComputeSoundVolume(void);
// void Audio_ComputeSoundReverb(void);
// void Audio_ComputeSoundPanSigned(void);
// void Audio_ComputeSoundFreqScale(void);
...
void Audio_RemoveSoundBankEntry(u8 bankId, u8 bankIndex);
void Audio_ChooseActiveSounds(u8 arg0);
