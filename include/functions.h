...
void* AudioHeap_AllocAttemptExternal(AudioAllocHeap* pool, size_t size);
void* AudioHeap_AllocDmaMemory(AudioAllocHeap* pool, size_t size);
void* AudioHeap_AllocZeroed(AudioAllocHeap* pool, size_t size);
void* AudioHeap_Alloc(AudioAllocHeap* pool, size_t size);
void AudioHeap_AllocHeapInit(AudioAllocHeap* pool, void* addr, size_t size);
...
s8 Audio_GetChannelIO(s32 playerIdx, s32 channelIdx, s32 scriptIdx);
