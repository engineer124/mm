...
// void AudioOcarina_StartOcarinaAtSongPos(void);
// void AudioOcarina_StartOcarinaForSongCheck(void);
// void AudioOcarina_StartOcarinaWithSongNoteLengths(void);
void AudioOcarina_StartOcarinaDefault(u32 arg0);
