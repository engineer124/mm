...
void Audio_PlaySfxAtPosWithSoundScriptIO(Vec3f* pos, u16 sfxId, u8 arg2);
void Audio_PlaySfxAtPosWithSoundScriptIOSetup(Vec3f* pos, u16 sfxId, u8 arg2);
...
// void Audio_PlayBgmNatureAmbience(void);
