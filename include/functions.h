...
void Environment_Init(PlayState* play, EnvironmentContext* envCtx);
u32 Environment_SmoothStepToU8(u8* param_1, u32 param_2, u32 param_3, u8 param_4, u8 param_5);
...
// void Environment_PlayTimeBasedSequence(void);
...
// void Environment_IsFinalHours(void);
...
void Audio_PlaySfx_BigBells(Vec3f* pos, u8 arg1);
