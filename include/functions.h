...
void Audio_PlaySequenceWithSeqPlayerIO(s8 seqPlayerIndex, u16 seqId, u8 fadeTimer, s8 ioPort, u8 ioData);
...
u8 func_801A3950(u8 seqPlayerIndex, u8 isChannelIOSet);
