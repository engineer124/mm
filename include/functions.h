...
// void Audio_SetObjSoundProperties(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE4 param_5, UNK_TYPE4 param_6, UNK_TYPE4 param_7);
// void Audio_StartFanfareAtPos(void);
void Audio_PlayMainBgmAtPos(Vec3f*, s8);
void Audio_PlayFanfareAtPos(Vec3f* arg0, s8 arg1);
// void Audio_UpdateFanfareAtPos(void);
// void Audio_StopSequenceAtPos(void);
// void Audio_StartSubBgmAtPos(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE4 param_5, UNK_TYPE4 param_6);
void Audio_PlaySubBgmAtPos(Vec3f* vec, u8 seqId, f32 arg2);
void Audio_PlaySubBgmAtPosWithFilter(Vec3f* vec, u8 seqId, f32 arg2);
