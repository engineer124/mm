...
// void SoundSource_PlaySoundByPositionWithReplays(void);
...
void* AudioHeap_AllocSampleCache(u32 size, s32 arg1, void* arg2, s8 arg3, s32 arg4);
...
void AudioHeap_DiscardSampleCacheForBank(SampleCacheEntry* entry, s32 arg1, s32 arg2, s32 bankId);
...
void AudioLoad_SetSampleBankLoadStatusAndApplyCaches(s32 arg0, s32 arg1);
void AudioLoad_SetSampleBankLoadStatus(s32 tabId, s32 status);
void AudioLoad_InitTable(AudioTable* table, u32 romAddr, u16 arg2);
// AudioBankData* AudioLoad_SyncLoadSeqBanks(s32 arg0, u32* arg1);
void AudioLoad_SyncLoadSeqParts(s32 channelIdx, s32 arg1, s32 arg2, OSMesgQueue* arg3);
s32 AudioLoad_SyncLoadSample(AudioBankSample* sample, s32 arg1);
...
void AudioLoad_AsyncLoadBank(s32 arg0, s32 arg1, s32 arg2, OSMesgQueue* queue);
u8* AudioLoad_GetBanksForSequence(s32 arg0, u32* arg1);
void AudioLoad_DiscardSeqBanks(s32 arg0);
void AudioLoad_DiscardBank(s32 arg0);
...
AudioBankSample* AudioLoad_GetBankSample(s32 bankId, s32 sfxId);
void AudioLoad_FinishSlowLoad(AudioSlowLoad* syncLoad);
void AudioLoad_ProcessSlowLoads(s32 resetStatus);
void AudioLoad_DmaSlowCopy(AudioSlowLoad* arg0, s32 size);
void AudioLoad_DmaSlowCopyUnkMedium(s32 arg0, s32 arg1, s32 arg2, s32 arg3);
s32 AudioLoad_SlowLoadSeq(s32 seqIdx, u8* ramAddr, s8* isDone);
...
s32 AudioLoad_AddToSampleSet(AudioBankSample* sample, s32 sampleCnt, AudioBankSample** sampleList);
s32 AudioLoad_GetSamplesForBank(s32 bankId, AudioBankSample** sampleList);
void AudioLoad_AddUsedSample(AudioBankSound* sound);
void AudioLoad_PreloadSamplesForBank(s32 bankId, s32 arg1, RelocInfo* relocInfo);
...
void Audio_SetSfxProperties(u8 bankIdx, u8 entryIdx, u8 channelIdx);
...
void Audio_PlayMessageCancelSfx(void); // Plays "No" sound
...
void Audio_PlaySfxGeneral(u16 sfxId, Vec3f* pos, u8 a2, f32* freqScale, f32* a4, s8* reverbAdd);
