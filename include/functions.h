...
void AudioSfx_LowerBgmVolume(u8 arg0);
void AudioSfx_RestoreBgmVolume(u8 arg0);
...
void AudioSfx_RemoveBankEntry(u8 bankId, u8 bankIndex);
void AudioSfx_ChooseActive(u8 arg0);
...
void AudioSfx_StopByTokenAndId(u8 arg0, u16 sfxId);
