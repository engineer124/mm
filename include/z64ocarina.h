...
typedef enum {
    ...
    /* 0x22 */ OCARINA_ACTION_CHECK_SONATA, // Playing songs for check spots
    ...
    /* 0x47 */ OCARINA_ACTION_PROMPT_ALT_SONATA, // Sonata different prompt
    /* 0x48 */ OCARINA_ACTION_PROMPT_ALT_GORON_LULLABY,
    /* 0x49 */ OCARINA_ACTION_PROMPT_ALT_NEW_WAVE,
    /* 0x4A */ OCARINA_ACTION_PROMPT_ALT_ELEGY,
    /* 0x4B */ OCARINA_ACTION_PROMPT_ALT_OATH,
    /* 0x4C */ OCARINA_ACTION_PROMPT_ALT_SARIAS,
    /* 0x4D */ OCARINA_ACTION_PROMPT_ALT_TIME,
    /* 0x4E */ OCARINA_ACTION_PROMPT_ALT_HEALING,
    /* 0x4F */ OCARINA_ACTION_PROMPT_ALT_EPONAS,
    /* 0x50 */ OCARINA_ACTION_PROMPT_ALT_SOARING,
    /* 0x51 */ OCARINA_ACTION_PROMPT_ALT_STORMS
} OcarinaSongActionId;
