...
void Message_DrawItemIcon(PlayState* play, Gfx** gfxP) {
    ...
    if (msgCtx->itemId == ITEM_RECOVERY_HEART) {
        ...
        gDPPipeSync(gfx++);
        gDPSetPrimColor(gfx++, 0, 0, sStrayFairyIconPrimColors[GET_DUNGEON_INDEX].r,
                        sStrayFairyIconPrimColors[GET_DUNGEON_INDEX].g, sStrayFairyIconPrimColors[GET_DUNGEON_INDEX].b,
                        msgCtx->textColorAlpha);
        gDPSetEnvColor(gfx++, sStrayFairyIconEnvColors[GET_DUNGEON_INDEX].r,
                       sStrayFairyIconEnvColors[GET_DUNGEON_INDEX].g, sStrayFairyIconEnvColors[GET_DUNGEON_INDEX].b, 0);
        ...
        gDPSetPrimColor(gfx++, 0, 0, 255, 255, 255, msgCtx->textColorAlpha);
        gDPLoadTextureBlock(gfx++, sStrayFairyIconTextures[GET_DUNGEON_INDEX], G_IM_FMT_RGBA, G_IM_SIZ_32b, 32, 24, 0,
...
void Message_OpenText(PlayState* play, u16 textId) {
    ...
    if (textId == 0xFF) {
        ...
        if (gSaveContext.save.saveInfo.inventory.strayFairies[GET_DUNGEON_INDEX] == 0xF) {
            textId = 0xF3;
        }
