                                                    ...
                                                    if ((curChar != 0x205) && (spDA = var_a3, (curChar != 0x206)) &&
                                                        ...
                                                        if (curChar == 0x20A) {
                                                            ...
                                                            do {
                                                                ...
                                                                spEA += 1;
                                                                if (var_s1_3 == 1) {
                                                                    Font_LoadChar(play, 0x8E9EU, spC8);
                                                                    spC8 += 0x80;
                                                                    msgCtx->decodedBuffer.wchar[spEA] = 0x8E9E;
                                                                    spEA += 1;
                                                                } else if (var_s1_3 == 3) {
                                                                    Font_LoadChar(play, 0x95AAU, spC8);
                                                                    spC8 += 0x80;
                                                            ...
                                                            Message_LoadChar(play, 0x9543U, &spC8, &spC0,
                                                                             (s16)(s32)spEA);
                                                            ...
                                                            Message_LoadChar(play, 0x906CU, &spC8, &spC0,
                                                                             (s16)(s32)spEA);
                                                            temp_t3_3 = spEA + 1;
                                                            spEA = temp_t3_3;
                                                            Message_LoadChar(play, 0x96DAU, &spC8, &spC0,
                                                                             (s16)(s32)temp_t3_3);
                                                            ...
                                                            do {
                                                                ...
                                                                Message_LoadChar(play, 0x8250U, &spC8, &spC0,
                                                                                 (s16)(s32)spEA);
                                                                var_s1_13 += 1;
                                                                spEA += 1;
                                                            } while (var_s1_13 < 5);
                                                            ...
                                                            do {
                                                                ...
                                                                Font_LoadChar(play, 0x8250U, spC8);
                                                                spC8 += 0x80;
                                                            ...
                                                            Message_LoadChar(play, 0x94ADU, &spC8, &spC0,
                                                                             (s16)(s32)spEA);
                                                        } else {
                                                            spDA = var_a3;
                                                            if (curChar != 0x22C) {
                                                                ...
                                                                if (curChar == 0x22E) {
                                                                    ...
                                                                    msgCtx->decodedBuffer.wchar[spEA] = 0x8E9E;
                                                                    spEA += 1;
                                                                    Font_LoadChar(play, 0x8AD4U, spC8);
                                                                    spC8 = temp_t5_3 + 0x80;
                                                                    msgCtx->decodedBuffer.wchar[spEA] = 0x8E9E;
                                                                    ...
                                                                    if ((curChar != 0x300) &&
                                                                        ...
                                                                        if ((curChar != 0x307) &&
                                                                            ...
                                                                            if ((curChar == 0x303) ||
                                                                                ...
                                                                                Message_LoadChar(play, 0x9543U, &spC8,
                                                                                                 &spC0, (s16)(s32)spEA);
                                                                            } else {
                                                                                if ((curChar == 0x30D) ||
                                                                                    (curChar == 0x30E) ||
