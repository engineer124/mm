        ...
        loop_13:
            ...
            if ((sOcarinaAvailSongs & temp_a3) != 0) {
                ...
                if (sp5F != 0) {
                    ...
                    if ((D_801FD4A0[i] >= (phi_a1 - 9)) && (D_801FD4A0[i] >= phi_a1) &&
                        (sOcarinaSongNotes[i][sLearnSongPos[i * 2]].length == 0) &&
                        (sLearnSongLastNote == D_801FD500[i])) {
                        D_801D8528 = i + 1;
                        sIsOcarinaInputEnabled = false;
                        sOcarinaFlags = 0;
                        if (D_801D8530 != 0) {
    ...
    switch (bankId) {
        ...
        case BANK_OCARINA:
            ...
            if (sAudioBaseFilter != 0) {
                if ((bankId == BANK_PLAYER) || (bankId == BANK_ITEM) || ((bankId == BANK_VOICE) && (((entry->sfxId & 0xFF) < 0x40) || ((entry->sfxId & 0xFF) >= 0x80)))) {
            ...
            if (((*entry->reverbAdd & 0x80) | baseFilter | sAudioExtraFilter | (entry->sfxUnk01 & 0x80)) != 0) {
                filter = ((((*entry->reverbAdd & 0x80) >> 2) | baseFilter | sAudioExtraFilter | ((entry->sfxUnk01 & 0x80) >> 2 )) * 2);
                filter &= 0xFF;
...
void func_801A13BC(u8 arg0, Vec3f* arg1, s8 arg2, u16 arg3) {
    s32 pad[3];
    s32 sp30;
    u32 temp_a0;
    ...
    if ((func_801A8A50(arg0) == 0x57) || ((func_801A8ABC(sp30 + 0x57, 0xFF0000FF) == 0)) || (D_801FD3D8 != 0)) {
        D_801FD3D8 = 1;
    } else if (arg1 != 0) {
        if ((arg2 != (s8)(func_801A8A50(arg0) & 0xFFFF)) && !gAudioContext.seqPlayers[arg0].enabled && (D_801D66FC == 0)) {
            
            temp_a0 = 0xFFFF; 
            temp_a0 = (((((Audio_NextRandom() % 0x1E) & 0xFF) + 1) << 0x10) | sp30) | ((arg2 & temp_a0) + arg3);
...
// z_obj_sound
void func_801A153C(Vec3f* arg0, s8 arg1) {
    s32 pad[2];
    u16 sp36;
    s32 sp2C;
    u16 temp_v1;
    ...
    if ((temp_v1 == 0x57) || (func_801A8ABC(0x57, 0xFF0000FF) == 0) || (D_801FD3D8 != 0)) {
        D_801FD3D8 = 1;
        return;
    }
    ...
    if (arg0 != NULL) {
        if (arg1 == 0x3A) {
            ...
            if ((arg1 != temp_v1_2) && (D_801FD3AF == 0)) {
                Audio_QueueSeqCmd((u16)arg1);
                D_801D66FC = arg1;
            } else if ((arg1 == temp_v1_2) && (D_801D66FC == 0)) {
                D_801D66FC = arg1;
            }
        ...
        if (D_801D66FC == 0) {
            temp_a0 = ((((Audio_NextRandom() % 0x1E) & 0xFF) + 1) << 0x10) | ((u16)arg1 + 0x7F00);
            Audio_QueueSeqCmd(temp_a0);
            D_801D66FC = arg1;
        }
        if (arg1 == 0x56) {
...
void func_801A1A8C(u8 arg0, Vec3f* arg1, u8 arg2, u8 arg3, f32 arg4, f32 arg5, f32 arg6) {
    f32 sp44;
    u8 temp_s0_2;
    u16 temp_v0;
    f32 phi_f0;
    ...
    if (((gAudioContext.seqPlayers[arg0].enabled  == 0) && (D_801FD3AF == 0)) || (temp_v0 == 0x81A)) {
        if (arg0 == 3) {
            Audio_SetVolScale(arg0, 3, 0x7F, 1);
        }

        Audio_QueueSeqCmd(((u32)arg0 << 0x18) | 0x10000 | arg2);
...
#define Audio_SeqCmdA2(playerIdx, a) \
    Audio_QueueSeqCmd(0xA0000000 | ((u32)playerIdx << 24) | ((a)))
