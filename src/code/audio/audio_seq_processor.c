...
ReverbSettings reverbSettings3[3] = {
    ...
    { 2, 0x50, 0x6000, 0, 0, 0x7FFF, 0xD000, 0x3000, 0xFF, 0x3000, 0x0, 0x0 },
};
...
ReverbSettings reverbSettings8[2] = {
    { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    { 1, 0x50, 0x5000, 0, 0, 0x7FFF, 0xD000, 0x3000, 0xFF, 0x3000, 0x0, 0x0 },
};
...
ReverbSettings reverbSettings10[3] = {
    { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    { 1, 0x30, 0x1800, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x0000, 0xB, 0xB },
};

ReverbSettings reverbSettings11[3] = {
    { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
};

ReverbSettings reverbSettings12[3] = {
    { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    { 1, 0x40, 0x5000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
};

ReverbSettings reverbSettings13[3] = {
    { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    { 1, 0x30, 0x6800, 0, 0, 0x7FFF, 0x1400, 0x1400, 0xFF, 0x3000, 0x6, 0x6 },
    { 2, 0x50, 0x6000, 0, 0, 0x7FFF, 0xD000, 0x3000, 0xFF, 0x3000, 0x0, 0x0 },
};

ReverbSettings reverbSettings14[3] = {
    { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    { 1, 0x30, 0x1800, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x0000, 0xB, 0xB },
    { 1, 0x40, 0x5000, 0, 0, 0x7FFF, 0x1800, 0x1800, 0xFF, 0x3000, 0x7, 0x7 },
};

ReverbSettings reverbSettings15[2] = {
    { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 },
    { 1, 0x50, 0x1800, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x0000, 0xB, 0xB },
};
...
AudioSpec gAudioSpecs[21] = {
    /* 0x0  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x1  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x2  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x3  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x4  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x5  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x6  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x7  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x8  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x9  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0xA  */ { 32000, 1, 28, 3, { 0 }, 2, { 0 }, reverbSettings10, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x2800, 0x2D00, 0, 0, 0xDC800 },
    /* 0xB  */ { 32000, 1, 28, 3, { 0 }, 2, { 0 }, reverbSettings10, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0xC  */ { 32000, 1, 28, 5, { 0 }, 2, { 0 }, reverbSettings10, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xCC800 },
    /* 0xD  */ { 32000, 1, 24, 5, { 0 }, 3, { 0 }, reverbSettings13, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0xE  */ { 32000, 1, 24, 5, { 0 }, 3, { 0 }, reverbSettings14, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0xF  */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings15, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4000, 0x2D00, 0, 0, 0xDC800 },
    /* 0x10 */ { 32000, 1, 22, 5, { 0 }, 2, { 0 }, reverbSettings0, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x11 */ { 32000, 1, 22, 5, { 0 }, 2, { 0 }, reverbSettings8, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x12 */ { 32000, 1, 16, 5, { 0 }, 2, { 0 }, reverbSettings0, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x13 */ { 22050, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings0, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    /* 0x14 */ { 32000, 1, 24, 5, { 0 }, 2, { 0 }, reverbSettings2, 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x3600, 0x2600, 0, 0, 0xDC800 },
};
            ...
            for (j = 0; j < gActiveSeqs[playerIdx].numSetupCmd; j++) {
                ...
                switch (setupOp) {
                    ...
                    case 0x5:
                        ...
                        AudioSeqCmd_StartSequence((u8)(setupPlayerIdx + 8), gActiveSeqs[setupPlayerIdx].setupFadeTimer, seqId);
