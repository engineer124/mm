...
// /* 0x00 */ ReverbSettings D_801DB4E0 = { 1, 0x30, 0x3000, 0, 0, 0x7FFF, 0x0000, 0x0000, 0xFF, 0x3000, 0x0, 0x0 };
...
AudioSpec gAudioSpecs[21] = {
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    ...
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 28, 3, { 0 }, 2, { 0 }, &D_801DB4E0[29], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x2800, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 28, 3, { 0 }, 2, { 0 }, &D_801DB4E0[29], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 28, 5, { 0 }, 2, { 0 }, &D_801DB4E0[29], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xCC800 },
    { 32000, 1, 24, 5, { 0 }, 3, { 0 }, &D_801DB4E0[38], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 3, { 0 }, &D_801DB4E0[41], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[44], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4000, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 22, 5, { 0 }, 2, { 0 }, &D_801DB4E0[0], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 22, 5, { 0 }, 2, { 0 }, &D_801DB4E0[24], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 16, 5, { 0 }, 2, { 0 }, &D_801DB4E0[0], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 22050, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[0], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x4100, 0x2D00, 0, 0, 0xDC800 },
    { 32000, 1, 24, 5, { 0 }, 2, { 0 }, &D_801DB4E0[6], 0x500, 0x200, 0x7FFF, 0xAF0, 0x2D80, 0, 0x3600, 0x2600, 0, 0, 0xDC800 },
};
    ...
    for (i = 0; i < ARRAY_COUNT(D_80200140); i++) {
        ...
        if (D_80200140[i].unk_4D != 0) {
            ...
            for (j = 0; j < D_80200140[i].unk_4D; j++) {
                ...
                playerIdx = (D_80200140[i].unk_2C[j] & 0x000F0000) >> 16;
                ...
                switch (temp_a0) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Audio_StartSeq((u8)(playerIdx + 8), 1, D_80200140[playerIdx].unk_254);
                        D_80200140[playerIdx].fadeVolUpdate = 1;
                        D_80200140[playerIdx].volScales[1] = 0x7F;
                        break;
                    case 3:
                    ...
                    case 5:
                        ...
                        Audio_StartSeq((u8)(playerIdx + 8), D_80200140[playerIdx].unk_4E, temp_v1);
                        Audio_SetVolScale(playerIdx, 1, 0x7F, 0);
                        D_80200140[playerIdx].unk_4E = 0;
                        break;
                    case 6:
