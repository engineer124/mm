...
s32 AudioOcarina_CheckValidOcarinaWallNotes(u8 songIdx, u8 maxSongIdx) {
    u8 i;
    u8 j;
    u8 k;
...
void AudioOcarina_GenOcarinaWallNotes(void) {
    ...
    } while (AudioOcarina_CheckValidOcarinaWallNotes(23, 23) != 0);
}
