...
void func_809961E4(EnSkb* this, GlobalContext* globalCtx) {
    ...
    this->unk_3E4 = 0;
    this->actor.flags &= ~1;
    AudioSource_CreateSoundSourceSoundSource(globalCtx, &this->actor.world.pos, 40, NA_SE_EN_STALKID_DEAD);
    this->unk_3DE = 7;
...
void func_80996BEC(EnSkb* this, GlobalContext* globalCtx) {
    ...
    AudioSource_CreateSoundSourceSoundSource(globalCtx, &this->actor.world.pos, 30, NA_SE_EV_ICE_BROKEN);
