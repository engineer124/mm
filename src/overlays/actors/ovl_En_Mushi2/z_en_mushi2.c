...
void func_80A6AB08(EnMushi2* this, PlayState* play) {
    ...
    if ((this->actor.flags & ACTOR_FLAG_IN_UNCULL_ZONE) && (Rand_ZeroOne() < 0.03f)) {
        Vec3f sp3C;
...
void func_80A6AE7C(EnMushi2* this, PlayState* play) {
    ...
    if ((this->actor.flags & ACTOR_FLAG_IN_UNCULL_ZONE) && (this->actor.depthInWater > 5.0f) &&
...
void func_80A6B0D8(EnMushi2* this, PlayState* play) {
    ...
    if ((this->actor.flags & ACTOR_FLAG_IN_UNCULL_ZONE) && (this->unk_368 > 20) && (Rand_ZeroOne() < 0.15f)) {
        Vec3f sp48;
        s32 sp44 = 0;
