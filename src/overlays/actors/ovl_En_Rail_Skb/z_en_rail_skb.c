...
void func_80B7114C(EnRailSkb* this, GlobalContext* globalCtx) {
    if (this->unk_3F0 == 0) {
        ...
        if (this->actor.colChkInfo.health != 0) {
            ...
            SoundSource_PlaySoundByPosition(globalCtx, &this->actor.world.pos, 40, NA_SE_EN_STALKID_DEAD);
            func_80B71488(this);
        }
...
void func_80B726B4(EnRailSkb* this, GlobalContext* globalCtx) {
    ...
    SoundSource_PlaySoundByPosition(globalCtx, &this->actor.world.pos, 30, NA_SE_EV_ICE_BROKEN);
