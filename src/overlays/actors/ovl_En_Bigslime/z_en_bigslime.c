...
void EnBigslime_ThrowPlayerIfRestrained(EnBigslime* this, PlayState* play) {
    ...
    if (player->stateFlags2 & PLAYER_STATE2_RESTRAINED_BY_ENEMY) {
        ...
        Player_SetKnockbackLargeNoDamage(play, &this->actor, 10.0f, this->actor.world.rot.y, 10.0f);
    }
}
...
void EnBigslime_WindupThrowPlayer(EnBigslime* this, PlayState* play) {
    ...
    if (this->windupPunchTimer > 0) {
        ...
        if (this->windupPunchTimer == -5) {
            ...
            Player_SetKnockbackLarge(play, &this->actor, 10.0f, this->actor.world.rot.y, 10.0f, 4);
...
void EnBigslime_FrozenFall(EnBigslime* this, PlayState* play) {
    ...
    if (i != BIGSLIME_NUM_RING_FACES) {
        Player_SetKnockbackLarge(play, &this->actor, 7.0f, this->actor.yawTowardsPlayer, 5.0f, 0x10);
    }
