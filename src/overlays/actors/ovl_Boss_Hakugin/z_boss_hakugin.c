...
void BossHakugin_CheckForBodyColliderHit(BossHakugin* this, PlayState* play) {
    ...
    if ((this->bodyCollider.base.atFlags & AT_HIT) &&
        ...
        if ((this->actionFunc == BossHakugin_Charge) &&
            ...
            !(this->bodyCollider.base.atFlags & AT_BOUNCED) && play->tryGrabbingPlayer(play, player)) {
            ...
            player->spinAttackTimer = player->speedXZ = -5.0f;
            player->dekuStickLength += player->spinAttackTimer * 0.05f;
