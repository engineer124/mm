...
#define FLAGS (ACTOR_FLAG_ATTENTION_ENABLED | ACTOR_FLAG_HOSTILE | ACTOR_FLAG_10 | ACTOR_FLAG_CANT_LOCK_ON)
...
void EnWizFire_Update(Actor* thisx, PlayState* play2) {
    ...
    if ((player->stateFlags2 & PLAYER_STATE2_FROZEN_IN_ICE) && (player->av2.actionVar2 < 90)) {
