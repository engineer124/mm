...
void Player_Init(Actor* thisx, PlayState* play) {
    ...
    gActorOverlayTable->initInfo->objectId = GAMEPLAY_KEEP;
...
void Player_SetDoAction(PlayState* play, Player* this) {
    ...
    if ((Message_GetState(&play->msgCtx) == TEXT_STATE_NONE) ||
        ...
        if (play->actorCtx.flags & ACTORCTX_FLAG_PICTO_BOX_ON) {
            ...
            doActionA = (this->unk_B28 == 2) ? DO_ACTION_REEL : DO_ACTION_NONE; //! Is that really fake? Isn't that just player dev's style?
            ...
            if ((this->csMode != PLAYER_CSMODE_5) && !(this->stateFlags1 & PLAYER_STATE1_800000)) {
                if (!(this->stateFlags2 & PLAYER_STATE2_80) && (this->actor.id == ACTOR_PLAYER)) {
                    if ((play->csCtx.playerCue != NULL) && (D_8085D384[play->csCtx.playerCue->id] != 0)) {
                        ...
                        Player_StopHorizontalMovement(this);
                    } else if (((u32)this->csMode == PLAYER_CSMODE_0) && !(this->stateFlags2 & (PLAYER_STATE2_400 | PLAYER_STATE2_8000000)) &&
...
s32 func_808482E0(PlayState* play, Player* this) {
    ...
    if (this->unk_AE7 == 0) {
        ...
        if ((this->getItemId >= GI_MASK_DEKU) && (this->getItemId <= GI_MASK_KAFEIS_MASK)) {
            ...
            // That extra temp just screams ternary (yes this matches).
            // But you don't have to change it, this is quite ugly
            s32 seqId = ((this->getItemId == GI_HEART_CONTAINER) ||
                ((this->getItemId == GI_HEART_PIECE) && EQ_MAX_QUEST_HEART_PIECE_COUNT)) ? NA_BGM_GET_HEART | 0x900 : ((this->getItemId == GI_HEART_PIECE) ||
                    ((this->getItemId >= GI_RUPEE_PURPLE) && (this->getItemId <= GI_RUPEE_HUGE))) ? NA_BGM_GET_SMALL_ITEM : NA_BGM_GET_ITEM | 0x900;
...
s32 func_80848E4C(Player* this, PlayState* play) {
    // You could make every call of ` = PlayerAnimation_Update(` consistent with naming that temp `animFinished`
...
void func_8084D820(Player* this, PlayState* play) {
    if (func_80838A90(this, play) == 0) {
        if ((this->stateFlags3 & PLAYER_STATE3_10) && !(this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)) {
            ...
            // changing the order still matches
            f32 sp5C = 5.0f;
            s32 sp58 = 0x14;
            s32 temp_v0_8;
