...
void Player_AfterPutAway_SetupGetItem(PlayState* play, Player* this);
...
ItemChangeInfo sItemChangeInfo[PLAYER_ITEM_CHG_MAX] = {
...
s8 sItemChangeTypes[PLAYER_ANIMTYPE_MAX][PLAYER_ANIMTYPE_MAX] = {
    {
...
bool Player_ItemIsInUse(Player* this, ItemId itemId) {
...
bool Player_ItemIsItemAction(Player* this, ItemId itemId, PlayerItemAction itemAction) {
...
void Player_ProcessItemButtons(Player* this, PlayState* play) {
    ...
    if (((this->actor.id == ACTOR_PLAYER) && (this->itemAction >= PLAYER_IA_FISHING_ROD)) &&
        ...
        itemId = Player_GetItemOnButton(play, this, i);
        if (itemId >= ITEM_FD) {
            for (i = 0; i < ARRAY_COUNT(sItemButtons); i++) {
...
s32 func_80831814(Player* this, PlayState* play, PlayerUnkAA5 arg2) {
    if (!(this->stateFlags1 & (PLAYER_STATE1_CLIMBING_ONTO_LEDGE_FROM_JUMP | PLAYER_STATE1_CARRYING_ACTOR |
    ...
    if ((((this->heldItemAction == this->itemAction) &&
        ...
        if (var_v1 ||
            ...
            if (var_v1 && (this->heldItemAction >= 0) && (itemId != this->heldItemId) &&
                (sItemChangeTypes[gPlayerModelTypes[this->modelGroup].modelAnimType][nextAnimType] !=
                 PLAYER_ITEM_CHG_0)) {
...
bool Player_IsBremenMarchOrKamaroDance(Player* this) {
...
bool Player_StartCutsceneWithCsId(Player* this, s16 csId) {
...
bool Player_StartCutsceneImpl(Player* this) {
...
bool Player_StartCutscene(Player* this) {
 ...
 */
s8 sActionHandlerListTargetEnemyStandStill[] = {
...
s8 sActionHandlerListFriendlyTargetingStandStill[] = {
    /*  0 */ PLAYER_ACTION_HANDLER_ITEM_FIRST_PERSON,
...
s8 sActionHandlerListEndSidewalk[] = {
    /*  0 */ PLAYER_ACTION_HANDLER_ITEM_FIRST_PERSON,
    /*  1 */ PLAYER_ACTION_HANDLER_DOOR,
    /*  2 */ PLAYER_ACTION_HANDLER_GET_ITEM,
...
s8 sActionHandlerListFriendlyBackwalk[] = {
    /* 0 */ PLAYER_ACTION_HANDLER_ITEM_FIRST_PERSON,
    /* 1 */ PLAYER_ACTION_HANDLER_GET_ITEM,
    /* 2 */ PLAYER_ACTION_HANDLER_TALK,
    /* 3 */ PLAYER_ACTION_HANDLER_THROW_PUT_DOWN,
...
s8 sActionHandlerListTargetRun[] = {
    /*  0 */ PLAYER_ACTION_HANDLER_ITEM_FIRST_PERSON,
    /*  1 */ PLAYER_ACTION_HANDLER_DOOR,
    /*  2 */ PLAYER_ACTION_HANDLER_GET_ITEM,
    /*  3 */ PLAYER_ACTION_HANDLER_MOUNT_HORSE,
...
s8 sActionHandlerListGoronRolling[] = {
    /* 0 */ PLAYER_ACTION_HANDLER_ITEM_FIRST_PERSON,
    /* 1 */ PLAYER_ACTION_HANDLER_GET_ITEM,
    /* 2 */ -PLAYER_ACTION_HANDLER_TALK,
};
    ...
    if (damageResponseType == PLAYER_HIT_RESPONSE_ICE_TRAP) {
        ...
        if (this->stateFlags1 & PLAYER_STATE1_SWIMMING) {
            ...
            if (damageResponseType == PLAYER_HIT_RESPONSE_KNOCKBACK_SMALL) {
                ...
                Player_Anim_PlayOnceFreeze(play, this, D_8085BE84[PLAYER_ANIMGROUP_FLINCH][this->modelAnimType]);
                Player_AnimSfx_PlayVoice(this, NA_SE_VO_LI_DAMAGE_S);
            } else {
...
bool Player_IsFloorSinking(FloorType floorType) {
...
s32 func_80836F10(PlayState* play, Player* this) {
    ...
    if ((sFloorType == FLOOR_TYPE_6) || (sFloorType == FLOOR_TYPE_9) || (this->csAction != PLAYER_CSACTION_NONE)) {
        fallDistance = 0;
    } else {
...
bool Player_CanLift(Player* this) {
            ...
            if (BgCheck_EntityLineTest2(&play->colCtx, &this->actor.world.pos, &sp7C, &sp70, &entityPoly, true, false,
                ...
                if (ABS_ALT(entityPoly->normal.y) < 0x258) {
                    ...
                    if ((temp_fv1_2 >= -11.0f) && (temp_fv1_2 <= 0.0f)) {
                        ...
                        if (var_v1_2) {
                            Player_SetupWaitForPutAway(play, this, Player_AfterPutAway_SetupClimb);
...
void func_80839ED0(Player* this, PlayState* play) {
    if (!(this->stateFlags3 & PLAYER_STATE3_FLYING_WITH_HOOKSHOT) && (Player_Action_ThrowDekuNut != this->actionFunc) &&
        !Player_IsBremenMarchOrKamaroDance(this)) {
        Player_SetRotToZero(this);
...
void Player_SetupBackwalkFriend(Player* this, s16 yawTarget, PlayState* play) {
...
void Player_SetupBackwalkEnemy(Player* this, s16 yawTarget, PlayState* play) {
    ...
    if (rideActor != NULL) {
        if ((rideActor->type != HORSE_TYPE_2) && (this->transformation != PLAYER_FORM_FIERCE_DEITY)) {
            ...
            if (CHECK_BTN_ALL(sControlInput->press.button, BTN_A)) {
                ...
                Player_SetupWaitForPutAway(play, this, Player_AfterPutAway_SetupRideHorse);
                ...
                if (this->getItemId < GI_MAX) {
                    ...
                    if ((Item_CheckObtainability(giEntry->itemId) == ITEM_NONE) ||
                        ...
                        if (!(this->stateFlags2 & PLAYER_STATE2_DIVING) ||
                            (this->currentBoots == PLAYER_BOOTS_ZORA_UNDERWATER)) {
                            Player_StopCutscene(this);
                            Player_SetupWaitForPutAwayWithCs(play, this, Player_AfterPutAway_SetupGetItem,
                ...
                if (!(this->stateFlags1 & PLAYER_STATE1_CARRYING_ACTOR)) {
                    if (this->getItemId != GI_NONE) {
                        if (CHECK_BTN_ALL(sControlInput->press.button, BTN_A)) {
                            ...
                            Player_SetupWaitForPutAway(play, this, Player_AfterPutAway_SetupGetItem);
                            this->stateFlags1 |=
                                (PLAYER_STATE1_GETTING_ITEM | PLAYER_STATE1_CARRYING_ACTOR | PLAYER_STATE1_IN_CUTSCENE);
                            Player_LoadGetItemObject(this, giEntry->objectId);
                        ...
                        if ((this->heldActor == NULL) || Player_IsHoldingHookshot(this)) {
                            ...
                            if (CHECK_BTN_ALL(sControlInput->press.button, BTN_A)) {
                                Player_SetupWaitForPutAway(play, this, Player_AfterPutAway_SetupLift);
                                Player_ClearAttentionModeAndStopMoving(this);
                                this->stateFlags1 |= PLAYER_STATE1_CARRYING_ACTOR;
...
void func_8083DF38(Player* this, PlayerAnimationHeader* anim, PlayState* play) {
    if (!Player_SetupWaitForPutAway(play, this, Player_AfterPutAway_SetupGrabWall)) {
        Player_SetAction(play, this, Player_Action_GrabWall, 0);
    }
...
s32 Player_GetZLockOnEnemyMoveDirection(Player* this, f32 speedTarget, s16 yawTarget) {
    ...
    if (((SQ(temp_fv1) * 50.0f) + 6.0f) < speedTarget) {
        return 1;
    }

    if ((((1.0f - temp_fv1) * 10.0f) + 6.8f) < speedTarget) {
        return -1;
    }
    return 0;
}
...
s32 Player_GetZParallelMoveDirection(Player* this, f32* speedTarget, s16* yawTarget, PlayState* play) {
    ...
    if ((Player_IsAimingFpsItem(this) || Player_IsAimingZoraFins(this)) && (this->focusActor == NULL)) {
        *speedTarget *= Math_SinS(var_a2);
        ...
        if (*speedTarget != 0.0f) {
            *yawTarget = (((temp_v1 >= 0) ? 1 : -1) * 0x4000) + this->actor.shape.rot.y;
        } else {
        ...
        Player_SetLookAngle(this, play);
        if ((*speedTarget != 0.0f) && (var_a2 < 0x1770)) {
            return 1;
        }

        if ((Math_SinS(0x4000 - (var_a2 >> 1)) * 200.0f) < *speedTarget) {
            return -1;
        }
    }
    return 0;
...
s32 Player_TryCrouchStab(Player* this, PlayState* play) {
    if (!Player_IsGoronOrDeku(this) && (Player_GetMeleeWeaponHeld(this) != PLAYER_MELEEWEAPON_NONE) &&
        (this->transformation != PLAYER_FORM_ZORA) && sUseHeldItem) {
...
bool Player_TryBreakingDekuStick(PlayState* play, Player* this) {
...
bool Player_TryBreakingRazorSword(PlayState* play, Player* this) {
...
void Player_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.shape.rot.x != 0) {
        this->actor.shape.rot.x = 0;
        this->csAction = PLAYER_CSACTION_PLAY_OCARINA;
        Player_SetAction(play, this, Player_Action_CsAction, 0);
        this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE;
        return;
    }
...
s8 sPlayerCueToCsActionMap[PLAYER_CUEID_MAX] = {
    ...
    PLAYER_CSACTION_PLAY_OCARINA,      // PLAYER_CUEID_PLAY_OCARINA
    PLAYER_CSACTION_PUT_AWAY_OCARINA,  // PLAYER_CUEID_PUT_AWAY_OCARINA
    ...
    PLAYER_CSACTION_SPAWN_ELEGY_SHELL, // PLAYER_CUEID_SPAWN_ELEGY_SHELL
...
void Player_UpdateCommon(Player* this, PlayState* play, Input* input) {
    ...
    if (this->stateFlags2 & PLAYER_STATE2_PAUSE_MOST_UPDATING) {
        ...
        if ((this->actor.parent == NULL) && (this->stateFlags1 & PLAYER_STATE1_RIDING_HORSE)) {
            this->actor.parent = this->rideActor;
            Player_AfterPutAway_SetupRideHorse(play, this);
            this->av2.actionVar2 = -1;
        ...
        if (play->csCtx.state != CS_STATE_IDLE) {
            if ((this->csAction != PLAYER_CSACTION_5) && !(this->stateFlags1 & PLAYER_STATE1_RIDING_HORSE)) {
        ...
        sWaterSpeedFactor = (this->stateFlags1 & PLAYER_STATE1_SWIMMING) ? 0.5f : 1.0f;
...
void func_80846460(Player* this) {
    ...
    bodyPartsPosPtr = this->bodyPartsPos;
    for (i = 0; i < PLAYER_BODYPART_MAX; i++) {
        Math_Vec3f_Copy(bodyPartsPosPtr, pos);
        bodyPartsPosPtr++;
    }
...
bool Player_TryGrabbingMikau(Player* this) {
...
void func_80847FF8(Player* this, f32* arg1, f32 speedTarget, s16 yawTarget) {
    Player_UpdateSwimMovement(this, arg1, speedTarget, yawTarget);
...
s32 func_80848094(PlayState* play, Player* this, f32* speedTarget, s16* yawTarget) {
    PlayerAnimationHeader* anim;
    s16 temp_v0 = this->yaw - *yawTarget;
    s32 temp_v0_2;
    ...
    if (ABS_ALT(temp_v0) > 0x6000) {
        ...
        temp_v0_2 = Player_GetZParallelMoveDirection(this, speedTarget, yawTarget, play);
        if (temp_v0_2 > 0) {
            anim = &gPlayerAnim_link_swimer_swim;
        } else if (temp_v0_2 < 0) {
            anim = &gPlayerAnim_link_swimer_back_swim;
        } else {
            s16 diff = BINANG_SUB(this->actor.shape.rot.y, *yawTarget);
...
void func_808481CC(PlayState* play, Player* this, f32 arg2) {
    ...
    Player_UpdateSwimMovement(this, &this->speedXZ, speedTarget / 2.0f, yawTarget);
...
s32 Player_UpperAction_ReadyFpsItemToShoot(Player* this, PlayState* play) {
    ...
    if ((this->unk_ACE > 0) && ((this->stickFlameTimer < 0) || (!sHeldItemButtonIsHeldDown && !func_80830FD4(play)))) {
...
void Player_Action_IdleLockOnEnemy(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListTargetEnemyStandStill, true)) {
        return;
    }

    if (!Player_UpdateHostileLockOn(this) &&
        (!Player_FriendlyLockOnOrParallel(this) || (Player_UpperAction_ShieldStanding != this->upperActionFunc))) {
    ...
    temp_v0 = Player_GetZLockOnEnemyMoveDirection(this, speedTarget, yawTarget);
    if (temp_v0 > 0) {
        Player_SetupRunTowardsYaw(this, play, yawTarget);
    } else if (temp_v0 < 0) {
...
void Player_Action_IdleZParallelOrLockOnFriend(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListFriendlyTargetingStandStill, true)) {
        return;
    }
    ...
    temp_v0 = Player_GetZParallelMoveDirection(this, &speedTarget, &yawTarget, play);
    if (temp_v0 > 0) {
        Player_SetupRunTowardsYaw(this, play, yawTarget);
    } else if (temp_v0 < 0) {
        Player_SetupBackwalkFriend(this, yawTarget, play);
    ...
    if (animDone ||
        ...
        if (this->av2.fallDamageStunTimer != 0) {
            ...
            this->skelAnime.jointTable[LIMB_ROOT_POS].y =
                (this->skelAnime.jointTable[LIMB_ROOT_POS].y + ((this->av2.fallDamageStunTimer & 1) * 80)) - 40;
        } else {
            Player_Anim_ResetMove(this);
...
void Player_Action_SidewalkSlow(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListEndSidewalk, true)) {
        return;
    }
...
void Player_Action_BackwalkFriend(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListFriendlyBackwalk, true)) {
        return;
    }
    ...
    sp2C = Player_GetZParallelMoveDirection(this, &speedTarget, &yawTarget, play);
    if (sp2C >= 0) {
...
void Player_Action_SidewalkFast(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListSidewalk, true)) {
        return;
    }
    ...
    Player_GetMovementSpeedAndYaw(this, &speedTarget, &yawTarget, SPEED_MODE_LINEAR, play);
    if (Player_FriendlyLockOnOrParallel(this)) {
        var_v0 = Player_GetZParallelMoveDirection(this, &speedTarget, &yawTarget, play);
    } else {
        var_v0 = Player_GetZLockOnEnemyMoveDirection(this, speedTarget, yawTarget);
    }
...
void Player_Action_Run(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListRun, true)) {
        return;
    }
...
void Player_Action_RunZTarget(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListTargetRun, true)) {
        return;
    }
...
void Player_Action_BackwalkEndEnemy(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListEndBackwalk, true)) {
        return;
    }
...
void Player_Action_ChargeSpinAttack(Player* this, PlayState* play) {
    ...
    if (!Player_TryInteracting(this, play) && (this->av2.actionVar2 != 0)) {
        ...
        if (this->av2.actionVar2 < 0) {
            ...
            Player_GetMovementSpeedAndYaw(this, &speedTarget, &yawTarget, SPEED_MODE_LINEAR, play);
            temp_v0 = Player_GetSpinAttackMoveDirection(this, &speedTarget, &yawTarget, play);
            if (temp_v0 > 0) {
...
void Player_Action_ChargeSpinAttackWalk(Player* this, PlayState* play) {
    ...
    targetYawDiff = yawTarget - this->yaw;
    ...
    if (absTargetYawDiff > 0x4000) {
        ...
        Math_ScaledStepToS(&this->yaw, yawTarget, absTargetYawDiff * 0.1f);
        if ((speedTarget == 0.0f) && (this->speedXZ == 0.0f)) {
...
void Player_Action_WaitForPutAway(Player* this, PlayState* play) {
    ...
    if (this->afterPutAwayFunc == Player_AfterPutAway_SetupGrabWall) {
        this->stateFlags2 |= PLAYER_STATE2_CAN_GRAB_PUSH_PULL_WALL;
    }
...
void Player_Action_ClimbWall(Player* this, PlayState* play) {
    ...
    if ((this->av2.actionVar2 < 0) || !Player_TryLettingGoWhileClimbing(this, play)) {
        if (PlayerAnimation_Update(play, &this->skelAnime)) {
            if (this->av2.actionVar2 < 0) {
                ...
                if (yStick > 0) {
                    ...
                    if (this->actor.world.pos.y < yIntersect) {
                        if (this->av1.actionVar1 != 0) {
                            ...
                            Player_SetupClimbEnd(this, this->ageProperties->unk_D4[this->av2.actionVar2], play);
                        }
                    } else {
                    ...
                    if (this->av1.actionVar1 != 0) {
                        ...
                        Player_SetupClimbEnd(this, this->ageProperties->unk_CC[this->av2.actionVar2], play);
                        this->av2.actionVar2 = 1;
                    }
                } else {
                    sp78 ^= 1;
...
void Player_Action_SwimIdle(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListSwim, true)) {
        return;
    }
    ...
    if (((this->av2.actionVar2 != 0) || !func_80850734(play, this))) {
        speedTarget = 0.0f;
        yawTarget = this->actor.shape.rot.y;
        ...
        if (this->currentBoots >= PLAYER_BOOTS_ZORA_UNDERWATER) {
            ...
            if (speedTarget != 0.0f) {
                if ((ABS_ALT(BINANG_SUB(this->actor.shape.rot.y, yawTarget)) > DEG_TO_BINANG(135.0f)) &&
                    !Math_StepToF(&this->speedXZ, 0.0f, 1.0f)) {
                    return;
                }

                if (Player_IsZTargetingWithHostileUpdate(this) || Player_TryGrabbingMikau(this)) {
                    Player_SetupSwimZTarget(play, this);
                } else {
                    Player_SetupSwimMove(play, this, yawTarget);
                }
            }
        }
...
void Player_Action_SwimZora(Player* this, PlayState* play) {
    ...
    if (Player_TryActionHandlerList(play, this, sActionHandlerListSwim, false)) {
        return;
    }
...
void Player_Action_SwimMove(Player* this, PlayState* play) {
    ...
    if (Player_IsZTargetingWithHostileUpdate(this) || Player_TryGrabbingMikau(this)) {
        ...
        if ((speedTarget == 0.0f) || (ABS_ALT(sp30) > 0x6000) || (this->currentBoots >= PLAYER_BOOTS_ZORA_UNDERWATER)) {
            Player_SetupSwimIdle(play, this);
        }
    }
...
void Player_Action_SwimZTarget(Player* this, PlayState* play) {
    ...
    if (speedTarget == 0.0f) {
        Player_SetupSwimIdle(play, this);
    } else if (!Player_IsZTargetingWithHostileUpdate(this) && !Player_TryGrabbingMikau(this)) {
        Player_SetupSwimMove(play, this, yawTarget);
    } else {
...
bool Player_HasPlayedOcarinaSong(PlayState* play, Player* this) {
    return ((play->sceneId == SCENE_MILK_BAR) && Audio_IsSequencePlaying(NA_BGM_BALLAD_OF_THE_WIND_FISH)) ||
           (((play->sceneId != SCENE_MILK_BAR) && (this->csAction == PLAYER_CSACTION_PLAY_OCARINA)) ||
...
void Player_UpdateZoraGuitarAnim(PlayState* play, Player* this) {
    if (Player_HasPlayedOcarinaSong(play, this)) {
        ...
        sControlInput = play->state.input;
        Lib_GetControlStickData(&analogStickDist, &prevControlStickAngle, sControlInput);

        // Adjust input values
        if (BINANG_ADD(prevControlStickAngle, 0x4000) < 0) {
            prevControlStickAngle -= 0x8000;
            analogStickDist = -analogStickDist;
        }

        // Clamp input angle
        if (prevControlStickAngle < -0x1F40) {
            prevControlStickAngle = -0x1F40;
        } else if (prevControlStickAngle > 0x2EE0) {
            prevControlStickAngle = 0x2EE0;
        }
        ...
        Math_SmoothStepToS(&this->upperLimbRot.y, prevControlStickAngle, 4, 0x7D0, 0);
...
void Player_SetupOcarina(PlayState* play, Player* this) {
    if (this->av2.actionVar2++ >= 3) {
        if ((this->transformation == PLAYER_FORM_ZORA) || (this->transformation == PLAYER_FORM_DEKU)) {
            Player_Anim_PlayOnceFreeze(play, this, sPlayerOcarinaPlayAnims[this->transformation]);
        } else if (this->transformation == PLAYER_FORM_GORON) {
...
void Player_Action_PlayOcarina(Player* this, PlayState* play) {
    ...
    if (this->attentionMode == PLAYER_ATTENTIONMODE_CUTSCENE) {
        ...
        f32 baseTranslX = this->skelAnime.jointTable[LIMB_ROOT_POS].x;
        f32 baseTranslZ = this->skelAnime.jointTable[LIMB_ROOT_POS].z;
        f32 baseTranslMag;
        ...
        this->skelAnime.jointTable[LIMB_ROOT_POS].x = baseTranslX * baseTranslMag;
        this->skelAnime.jointTable[LIMB_ROOT_POS].z = baseTranslZ * baseTranslMag;
    } else {
...
void Player_Action_GetItem(Player* this, PlayState* play) {
    ...
    if (PlayerAnimation_Update(play, &this->skelAnime)) {
        if (this->av2.actionVar2 != 0) {
            ...
            if (Player_TryGetItem(play, this) && (this->av2.actionVar2 == 1)) {
                Player_SetModels(this, Player_ActionToModelGroup(this, this->itemAction));
...
void Player_Action_DrinkFromBottle(Player* this, PlayState* play) {
    ...
    if (PlayerAnimation_Update(play, &this->skelAnime)) {
        if (this->av2.bottleDrinkState == BOTTLE_DRINK_STATE_START) {
            ...
            this->av2.bottleDrinkState = BOTTLE_DRINK_STATE_WAIT;
        } else if (this->av2.bottleDrinkState < 0) {
            this->av2.bottleDrinkState++;
            if (this->av2.bottleDrinkState == 0) {
                this->av2.bottleDrinkState = BOTTLE_DRINK_STATE_DEKU_END;
                this->skelAnime.endFrame = this->skelAnime.animLength - 1.0f;
            } else if (this->av2.bottleDrinkState == BOTTLE_DRINK_STATE_DEKU_PUFF) {
    ...
    } else if (this->av2.bottleDrinkState == BOTTLE_DRINK_STATE_WAIT) {
        if ((gSaveContext.healthAccumulator == 0) && (gSaveContext.magicState != MAGIC_STATE_FILL)) {
            if (this->transformation == PLAYER_FORM_DEKU) {
                ...
                PlayerAnimation_Change(play, &this->skelAnime, &gPlayerAnim_pn_drinkend, PLAYER_ANIM_ADJUSTED_SPEED,
                                       0.0f, 5.0f, 2, -6.0f);
                this->av2.bottleDrinkState = BOTTLE_DRINK_STATE_DEKU;
            } else {
                Player_Anim_PlayOnceMorphAdjusted(play, this, &gPlayerAnim_link_bottle_drink_demo_end);
                this->av2.bottleDrinkState = BOTTLE_DRINK_STATE_END;
            }
    ...
    } else if ((this->av2.bottleDrinkState == BOTTLE_DRINK_STATE_END) &&
               PlayerAnimation_OnFrame(&this->skelAnime, 29.0f)) {
        Player_AnimSfx_PlayVoice(this, NA_SE_VO_LI_BREATH_DRINK);
    }
}
...
void Player_Action_ExchangeItem(Player* this, PlayState* play) {
    ...
    if (PlayerAnimation_Update(play, &this->skelAnime)) {
        if (this->exchangeItemAction == PLAYER_IA_NONE) {
            ...
            if (this->av2.exchangeItemState == EXCHANGE_ITEM_STATE_INIT) {
                if ((this->actor.textId != 0) && (this->actor.textId != 0xFFFF)) {
                    Message_StartTextbox(play, this->actor.textId, &this->actor);
                }

                this->av2.exchangeItemState = EXCHANGE_ITEM_STATE_TEXT_STARTED;
            } else if (Message_GetState(&play->msgCtx) == TEXT_STATE_CLOSING) {
                Player_StopCutscene(this);
                this->getItemDrawIdPlusOne = GID_NONE + 1;
                this->actor.flags &= ~ACTOR_FLAG_PLAYER_TALKING;
...
void Player_Action_ElectricShock(Player* this, PlayState* play) {
    ...
    if (((this->av2.actionVar2 % 25) != 0) || (Player_InflictDamageImpl(play, this, -1) != 0)) {
        if (DECR(this->av2.actionVar2) == 0) {
            Player_Setup1_IdleAll(this, play);
        }
    }
...
void Player_Action_Attack(Player* this, PlayState* play) {
    ...
    if (PlayerAnimation_Update(play, &this->skelAnime) ||
        ...
        this->av2.actionVar2 |= CHECK_BTN_ALL(sControlInput->press.button, BTN_B) ? 1 : 0;
    }
}
...
// Goron curled
void Player_Action_GoronRoll(Player* this, PlayState* play) {
    if (Player_TryActionHandlerList(play, this, sActionHandlerListGoronRolling, false)) {
        return;
    }
    ...
    if (!Player_TryGoronUncurling(play, this)) {
        ...
        if (this->unk_B86[1] != 0) {
            ...
            if ((this->stateFlags3 & PLAYER_STATE3_80000) &&
                (!CHECK_BTN_ALL(sControlInput->cur.button, BTN_A) ||
                 (gSaveContext.save.saveInfo.playerData.magic == 0) ||
                 ((this->av1.actionVar1 == 4) && (this->spinAttackTimer < 12.0f)))) {
...
PlayerCsActionEntry sPlayerCsActionInitFuncs[PLAYER_CSACTION_MAX] = {
    ...
    /* PLAYER_CSACTION_PLAY_OCARINA_HUMAN  */ { PLAYER_CSTYPE_ACTION, { Player_CsAction_PullOutOcarinaHuman } },
    ...
    /* PLAYER_CSACTION_PLAY_OCARINA  */ { PLAYER_CSTYPE_ACTION, { Player_CsAction_PullOutOcarina } },
    /* PLAYER_CSACTION_PUT_AWAY_OCARINA  */ { PLAYER_CSTYPE_ACTION, { Player_CsAction_PutAwayOcarina } },
    ...
    /* PLAYER_CSACTION_SPAWN_ELEGY_SHELL */ { PLAYER_CSTYPE_ACTION, { Player_CsAction_SpawnElegyShell } },
...
PlayerCsActionEntry sPlayerCsActionUpdateFuncs[PLAYER_CSACTION_MAX] = {
    ...
    /* PLAYER_CSACTION_PLAY_OCARINA_HUMAN  */ { PLAYER_CSTYPE_ANIM_17, { &gPlayerAnim_link_normal_okarina_swing } },
    ...
    /* PLAYER_CSACTION_PLAY_OCARINA  */ { PLAYER_CSTYPE_ACTION, { Player_CsAction_PlayOcarina } },
    /* PLAYER_CSACTION_PUT_AWAY_OCARINA  */ { PLAYER_CSTYPE_ANIM_11, { NULL } },
    ...
    /* PLAYER_CSACTION_SPAWN_ELEGY_SHELL */ { PLAYER_CSTYPE_ANIM_11, { NULL } },
...
void Player_CsAction_48(PlayState* play, Player* this, CsCmdActorCue* cue) {
    ...
    if ((play->csCtx.state == CS_STATE_IDLE) || (play->csCtx.state == CS_STATE_STOP) ||
        ...
        if (sPlayerCueToCsActionMap[this->cueId] != PLAYER_CSACTION_PLAY_OCARINA_HUMAN) {
