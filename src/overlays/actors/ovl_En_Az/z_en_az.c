...
void EnAz_Init(Actor* thisx, PlayState* play2) {
    ...
    switch (BEAVER_GET_PARAM_F00(thisx)) {
        case 0:
            phi_v1 = (GET_SCENE_ENTRANCE == ENTRANCE(WATERFALL_RAPIDS, 0)) && CHECK_WEEKEVENTREG(WEEKEVENTREG_93_01);
            phi_v1 = !phi_v1;
            break;

        case 2:
            phi_v1 = (GET_SCENE_ENTRANCE != ENTRANCE(WATERFALL_RAPIDS, 1)) || !CHECK_WEEKEVENTREG(WEEKEVENTREG_24_04);
            break;

        case 4:
            phi_v1 = GET_SCENE_ENTRANCE != ENTRANCE(WATERFALL_RAPIDS, 2);
            break;
    ...
    switch (GET_SCENE_ENTRANCE) {
        ...
        case ENTRANCE(WATERFALL_RAPIDS, 3):
            ...
            if (GET_SCENE_ENTRANCE == ENTRANCE(WATERFALL_RAPIDS, 3)) {
                this->unk_2FA = 0xA;
            }
            func_80A97C0C(this, play);
            break;
