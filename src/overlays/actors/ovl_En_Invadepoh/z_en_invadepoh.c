...
void func_80B4627C(EnInvadepoh* this, GlobalContext* globalCtx) {
    ...
    if (D_80B4E940 == 1) {
        ...
        if (gSaveContext.time < CLOCK_TIME(2, 31)) {
            ...
            AudioSeqCmd_StartSequence(AUDIO_PLAYER_BGM_MAIN, 0, NA_BGM_ALIEN_INVASION | 0x8000);
            func_80B46F88(this);
        }
...
void func_80B47D30(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (D_80B4E940 == 3) {
        ...
        SoundSource_PlaySoundByPosition(globalCtx, &thisx->world.pos, 50, NA_SE_EN_INVADER_DEAD);
        func_80B47830(this);
    }
