...
void func_80B9FF80(EnZob* this, PlayState* play) {
    ...
    if (play->msgCtx.ocarinaMode == OCARINA_MODE_EVENT) {
        ...
        Message_StartOcarinaStaff(play, OCARINA_ACTION_DEMONSTRATE_EVAN_PART2_FIRST_HALF);
        ...
        case TEXT_STATE_5:
            if (Message_ShouldAdvance(play)) {
                switch (play->msgCtx.currentTextId) {
                    ...
                    case 0x1209:
                        Message_StartOcarinaStaff(play, OCARINA_ACTION_DEMONSTRATE_EVAN_PART1_FIRST_HALF);
                        this->unk_304 = 4;
                        func_80B9F7E4(this, 0, ANIMMODE_LOOP);
