...
void ObjHunsui_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_172 & 0x10) {
        ...
        Audio_PlaySfxAtPosWithFreq(&this->dyna.actor.projectedPos, NA_SE_EV_WATER_PILLAR - SFX_FLAG, 1.0f + temp_f8);
    }
...
void func_80B9DA60(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_172 & 0x10) {
        ...
        Audio_PlaySfxAtPosWithFreq(&this->dyna.actor.projectedPos, NA_SE_EV_WATER_PILLAR - SFX_FLAG, 1.0f + temp);
    }
