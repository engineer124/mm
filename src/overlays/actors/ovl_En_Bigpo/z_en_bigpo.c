...
#define FLAGS (ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_4 | ACTOR_FLAG_10 | ACTOR_FLAG_200 | ACTOR_FLAG_1000)
...
void EnBigpo_SetupLanternDrop(EnBigpo* this, PlayState* play) {
    ...
    this->actor.flags &= ~(ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_4); // targetable OFF, enemy music OFF
