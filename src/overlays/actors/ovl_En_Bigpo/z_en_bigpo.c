...
#define FLAGS (ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_ENEMY | ACTOR_FLAG_10 | ACTOR_FLAG_200 | ACTOR_FLAG_IGNORE_QUAKE)
...
void EnBigpo_SetupLanternDrop(EnBigpo* this, PlayState* play) {
    ...
    this->actor.flags &= ~(ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_ENEMY); // targetable OFF, enemy music OFF
...
void EnBigpo_SetupScoopSoulLeaving(EnBigpo* this) {
    this->actor.flags &= ~(ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_IMMEDIATE_TALK); // targetable OFF and unknown OFF
