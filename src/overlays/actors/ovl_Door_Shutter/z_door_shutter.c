...
s32 func_808A1340(DoorShutter* this, PlayState* play) {
    ...
    if (this->unk_163 == 7) {
        ...
        if (this->unk_163 == 7) {
            Actor_PlaySfx_Flagged(&this->door.dyna.actor, NA_SE_EV_IKANA_DOOR_OPEN - SFX_FLAG);
        }
...
s32 func_808A1A70(DoorShutter* this) {
    if (this->unk_163 == 7) {
        if (this->unk_163 == 7) {
            Actor_PlaySfx_Flagged(&this->door.dyna.actor, NA_SE_EV_IKANA_DOOR_CLOSE - SFX_FLAG);
        }
