...
#define FLAGS (ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_8 | ACTOR_FLAG_10 | ACTOR_FLAG_100000 | ACTOR_FLAG_2000000)
...
void EnHg_ChasePlayer(EnHg* this, PlayState* play) {
    ...
    if (!(player->stateFlags2 & PLAYER_STATE2_PLAYING_OCARINA) && Message_GetState(&play->msgCtx) == TEXT_STATE_NONE) {
