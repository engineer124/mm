...
#define ENDEKUNUTS_GET_FF(thisx) ((thisx)->params & 0xFF)

typedef enum EnDekunutsParamFF {
    /* 0x00 */ ENDEKUNUTS_PARAM_FF_0,
    /* 0x01 */ ENDEKUNUTS_PARAM_FF_1,
    /* 0x02 */ ENDEKUNUTS_PARAM_FF_2,
    /* 0xFF */ ENDEKUNUTS_PARAM_FF_FF = 0xFF
} EnDekunutsParamFF;
