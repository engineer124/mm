...
void EnWdhand_Idle(EnWdhand* this, PlayState* play) {
    ...
    if (!(player->stateFlags2 & PLAYER_STATE2_RESTRAINED_BY_ENEMY) && (this->actor.xyzDistToPlayerSq < SQ(120.75f))) {
...
void EnWdhand_LungeForPlayer(EnWdhand* this, PlayState* play) {
    ...
    if ((this->collider.base.atFlags & AT_HIT) && play->tryGrabbingPlayer(play, player)) {
