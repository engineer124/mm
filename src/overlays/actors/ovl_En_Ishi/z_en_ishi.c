...
void func_8095E660(EnIshi* this, GlobalContext* globalCtx) {
    ...
    if (Actor_HasParent(&this->actor, globalCtx)) {
        func_8095E934(this);
        SoundSource_PlaySoundByPosition(globalCtx, &this->actor.world.pos, 20, D_8095F7AC[sp38]);
    ...
    if (sp34 && (sp38 == 0) && (this->collider.info.acHitInfo->toucher.dmgFlags & 0x508)) {
        ...
        SoundSource_PlaySoundByPosition(globalCtx, &this->actor.world.pos, D_8095F6D4[sp38], D_8095F6D0[sp38]);
...
void func_8095EBDC(EnIshi* this, GlobalContext* globalCtx) {
    ...
    if ((this->actor.bgCheckFlags & 9) || temp_v0 || (this->unk_194 <= 0)) {
        ...
        if (!(this->actor.bgCheckFlags & 0x20)) {
            SoundSource_PlaySoundByPosition(globalCtx, &this->actor.world.pos, D_8095F6D4[sp70], D_8095F6D0[sp70]);
...
void func_8095F0A4(EnIshi* this, GlobalContext* globalCtx) {
    ...
    if (ActorCutscene_GetCanPlayNext(this->actor.cutscene)) {
        ...
        SoundSource_PlaySoundByPosition(globalCtx, &this->actor.world.pos, D_8095F6D4[sp28], D_8095F6D0[sp28]);
