...
void ObjKibako_Idle(ObjKibako* this, GlobalContext* globalCtx) {
    ...
    if (Actor_HasParent(&this->actor, globalCtx)) {
        ...
        ObjKibako_SpawnCollectible(this, globalCtx);
        AudioSource_CreateSoundSourceSoundSource(globalCtx, &this->actor.world.pos, 20, NA_SE_EV_WOODBOX_BREAK);
        AudioSource_CreateSoundSourceSoundSource(globalCtx, &this->actor.world.pos, 40, NA_SE_EV_DIVE_INTO_WATER_L);
        Actor_MarkForDeath(&this->actor);
