        ...
        if (ptr->unk_00 != 0) {
            ...
            if (ptr->unk_00 == 1) {
                ...
                if ((ptr->unk_04.y <= this->actor.floorHeight) || phi_v0) {
                    ...
                    if (phi_v0) {
                        ptr->unk_00 = 0;
                        SoundSource_PlaySoundByPosition(globalCtx, &ptr->unk_04, 30, NA_SE_EV_BOMB_DROP_WATER);
                    } else {
                        ptr->unk_04.y = this->actor.floorHeight;
                        if (ptr->unk_2A == 0) {
                            SoundSource_PlaySoundByPosition(globalCtx, &ptr->unk_04, 30, NA_SE_EV_WATERDROP_GRD);
                            ptr->unk_00 = 3;
                            ptr->unk_2C.x = 0.1f;
                            ptr->unk_2C.y = 0.6f;
                            ptr->unk_10 = D_80A5AFB0;
                            ...
                            ptr->unk_00 = 0;
                            SoundSource_PlaySoundByPosition(globalCtx, &ptr->unk_04, 30, NA_SE_EV_WATERDROP);
                ...
                if ((ptr->unk_2A % 2) == 0) {
                    ...
                    if ((ptr->unk_04.y <= temp_f0_2) || (phi_s5 != 0)) {
                        ...
                        if (ptr->unk_2A == 0) {
                            ...
                            SoundSource_PlaySoundByPosition(globalCtx, &ptr->unk_04, 30, NA_SE_EV_PLANT_BROKEN);
                        }
                        ptr->unk_2A++;
                    }
                }
