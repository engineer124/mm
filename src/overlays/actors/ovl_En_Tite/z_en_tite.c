...
void func_80895020(EnTite* this, GlobalContext* globalCtx) {
    ...
    SoundSource_PlaySoundByPosition(globalCtx, &this->actor.world.pos, 40, NA_SE_EN_TEKU_DEAD);
    this->actor.flags &= ~1;
...
void func_808951B8(EnTite* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_2BC == 0) {
        for (i = 0; i < ARRAY_COUNT(this->unk_2D0); i++) {
            ...
            SoundSource_PlaySoundByPosition(globalCtx, &this->unk_2D0[i], 11, NA_SE_EN_EXTINCT);
        }
