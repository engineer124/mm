        ...
        if (((curSyllable != 'ー') && (curSyllable < 'ぁ')) || ((curSyllable > 'ん') && (curSyllable < 'ァ')) ||
            ...
            errorCode = CONT_ERR_VOICE_WORD;
                   ...
                   ((curSyllable == 'ー') || (curSyllable == 'あ') || (curSyllable == 'い') || (curSyllable == 'う') ||
                    ...
                    (curSyllable == 'ょ') || (curSyllable == 'っ') || (curSyllable == 'ゎ')

                    || (curSyllable == 'ア') || (curSyllable == 'イ') || (curSyllable == 'ウ') ||
                    (curSyllable == 'エ') || (curSyllable == 'オ') || (curSyllable == 'ナ') || (curSyllable == 'ニ') ||
                    (curSyllable == 'ヌ') || (curSyllable == 'ネ') || (curSyllable == 'ノ') || (curSyllable == 'マ') ||
                    (curSyllable == 'ミ') || (curSyllable == 'ム') || (curSyllable == 'メ') || (curSyllable == 'モ') ||
                    (curSyllable == 'ヤ') || (curSyllable == 'ユ') || (curSyllable == 'ヨ') || (curSyllable == 'ラ') ||
                    (curSyllable == 'リ') || (curSyllable == 'ル') || (curSyllable == 'レ') || (curSyllable == 'ロ') ||
                    (curSyllable == 'ワ') || (curSyllable == 'ヰ') || (curSyllable == 'ヱ') || (curSyllable == 'ヲ') ||
                    (curSyllable == 'ン') || (curSyllable == 'ァ') || (curSyllable == 'ィ') || (curSyllable == 'ゥ') ||
                    (curSyllable == 'ェ') || (curSyllable == 'ォ') || (curSyllable == 'ャ') || (curSyllable == 'ュ') ||
                    (curSyllable == 'ョ') || (curSyllable == 'ッ') || (curSyllable == 'ヮ'))) {
            errorCode = CONT_ERR_VOICE_WORD;
        }
