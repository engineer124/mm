...
weekEventReg = {
    ...
    (30 << 8) | 0x10: "WEEKEVENTREG_USED_DEKU_MASK",
    (30 << 8) | 0x20: "WEEKEVENTREG_USED_GORON_MASK",
    (30 << 8) | 0x40: "WEEKEVENTREG_USED_ZORA_MASK",
    (30 << 8) | 0x80: "WEEKEVENTREG_USED_FIERCE_DIETY_MASK",
    (31 << 8) | 0x01: "WEEKEVENTREG_TATL_HINT_CLOCK_TOWN_NORTH_GATE",
    (31 << 8) | 0x02: "WEEKEVENTREG_TATL_HINT_CLOCK_TOWN_WEST_GATE",
    (31 << 8) | 0x04: "WEEKEVENTREG_TATL_HINT_CLOCK_TOWN_SOUTH_GATE",
    ...
    (79 << 8) | 0x10: "WEEKEVENTREG_TATL_HINT_CLOCK_TOWER_MIDNIGHT",
    ...
    (80 << 8) | 0x04: "WEEKEVENTREG_TATL_HINT_CLOCK_TOWN_EAST_GATE",
    ...
    (87 << 8) | 0x10: "WEEKEVENTREG_TATL_HINT_COMPLETED_ODOLWA",
    (87 << 8) | 0x20: "WEEKEVENTREG_TATL_HINT_COMPLETED_GOHT",
    (87 << 8) | 0x40: "WEEKEVENTREG_TATL_HINT_COMPLETED_GYORG",
    (87 << 8) | 0x80: "WEEKEVENTREG_TATL_HINT_COMPLETED_TWINMOLD",
    ...
    (88 << 8) | 0x20: "WEEKEVENTREG_TATL_HINT_CLOCK_TOWER_OPENED",
