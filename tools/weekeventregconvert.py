...
weekEventReg = {
    ...
    (33 << 8) | 0x08: "WEEKEVENTREG_SAVED_BOMB_LADY",
    ...
    (50 << 8) | 0x80: "WEEKEVENTREG_TALKED_TO_KAFEI_AFTER_LETTER",
    (51 << 8) | 0x01: "WEEKEVENTREG_GAVE_PENDANT_TO_ANJU",
    (51 << 8) | 0x02: "WEEKEVENTREG_51_02",
    (51 << 8) | 0x04: "WEEKEVENTREG_HIT_KAFEI_BELL",
    (51 << 8) | 0x08: "WEEKEVENTREG_OBTAINED_PENDANT",
    (51 << 8) | 0x10: "WEEKEVENTREG_SAKON_HIDEOUT_OPENED",
    (51 << 8) | 0x20: "WEEKEVENTREG_SAVED_SUN_MASK",
    (51 << 8) | 0x40: "WEEKEVENTREG_COUPLES_MASK_CS_FINISHED",
    ...
    (58 << 8) | 0x80: "WEEKEVENTREG_SAKON_HIDEOUT_IS_OPENING",
    ...
    (61 << 8) | 0x08: "WEEKEVENTREG_SAKON_HIDEOUT_SPOTTED",
    ...
    (79 << 8) | 0x40: "WEEKEVENTREG_SAKON_EXPLODED",
    ...
    (90 << 8) | 0x02: "WEEKEVENTREG_KAFEI_GOING_TO_ANJU",
