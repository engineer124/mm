...
make distclean
make setup -j14 2> tools/warnings_count/warnings_setup_new.txt
make disasm -j14 2> tools/warnings_count/warnings_disasm_new.txt
make all -j14 2> tools/warnings_count/warnings_build_new.txt
