...
void func_80C1019C(EnRecepgirl* this, PlayState* play) {
    ...
    if (Actor_AcceptTalkRequest(&this->actor, &play->state) != 0) {
        func_80C10290(this);
